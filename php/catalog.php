...
<body>
		...
		<div class="content">
			<div class="search_panel">
				<form action="catalog.php" style="text-align: right;">
				  <input type="text" placeholder="Search.." name="search" value="<?php echo $search_value; ?>" style="padding: 10px; size: 50px;" />
	...
	<table style="width:100%; background-color: white;" class="slidestable">
		...
		<tr>
			<td style="width:25%" bgcolor="black" ><a href=""><img src="/Coursework/Images/1.jpg" style="width:100%;" class="slidesimg" ></a></td>
			<td style="width:25%" bgcolor="black"><a href=""><img src="/Coursework/Images/2.jpg" style="width:100%;" class="slidesimg"></a></td>
			<td style="width:25%" bgcolor="black"><a href=""><img src="/Coursework/Images/3.jpg" style="width:100%;" class="slidesimg"></a></td>
			<td style="width:25%" bgcolor="black"><a href=""><img src="/Coursework/Images/4.jpg" style="width:100%;" class="slidesimg"></a></td>
		</tr>
		<tr>
			<td style="width:25%" bgcolor="black" ><a href=""><img src="/Coursework/Images/5.jpg" style="width:100%;" class="slidesimg" ></a></td>
			<td style="width:25%" bgcolor="black"><a href=""><img src="/Coursework/Images/6.jpg" style="width:100%;" class="slidesimg"></a></td>
			<td style="width:25%" bgcolor="black"><a href=""><img src="/Coursework/Images/7.jpg" style="width:100%;" class="slidesimg"></a></td>
			<td style="width:25%" bgcolor="black"><a href=""><img src="/Coursework/Images/8.jpg" style="width:100%;" class="slidesimg"></a></td>
		</tr>
	</table>
</div>
