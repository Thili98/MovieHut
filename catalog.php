		...
		<header>
			<table class="header1">
				<tr>
					...
					<td class="login"><a href="Login.php"> Login</a></td>
					<td class="reg"><a href="Register.php">Register</a></td>
				</tr>
			</table>
		</header>
</head>
<body>
	<div style="opacity: 1">
		...
		<!--Connect to the movie table in the database-->
		<?php
				...
				<div>
					...
					<div class="desc">
						...
						<h4>Type :- <span><?php  echo $row["fil_type"] ?><br></span>
							<a href="login.php">RESERVE NOW</a>
						</h4>
